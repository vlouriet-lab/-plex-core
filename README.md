...
| Msg Crypto    | ChaCha20-Poly1305 placeholder → Double Ratchet |
...
```
  ...
  - `init_node(data_dir: String, db_key: String)` — инициализирует ядро. `data_dir` — путь к папке для хранения БД, `db_key` — ключ шифрования SQLCipher.
